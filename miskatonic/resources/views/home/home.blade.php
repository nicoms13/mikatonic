...
<body>
	...
	<nav>
		<a href="" class="brand">Miskatonic</a>
	...
	<section class="home">
		<div class="content">
			...
			<a class="signup" href="{{ route('register') }}">SIGN UP NOW <i class="fas fa-chevron-right btn-icon"></i></a>
			<a class="signin" href="{{ route('login') }}">I already have an account</a>
		</div>
	</section>
	...
	<section class="mainsection">
		...
		<div class="carousel">
			<div class="carousel-items">
				<div class="carousel-img">
					<img src="img/hplovecraft.jpg">
				</div>
				<div class="carousel-img">
					<img src="img/algernonblackwood.jpg">
				</div>
				<div class="carousel-img">
					<img src="img/allanpoe.jpg">
				</div>
				<div class="carousel-img">
					<img src="img/sanderson.jpg">
				</div>
				<div class="carousel-img">
					<img src="img/sapkowski.jpg">
				</div>
				<div class="carousel-img">
					<img src="img/ashtonsmith.jpg">
				</div>
			</div>
		</div>
		...
		<div class="carousel-two">
			<div class="carousel-items-two">
				<div class="carousel-img-two">
					<img src="img/cthulu.jpg">
				</div>
				<div class="carousel-img-two">
					<img src="img/dagon.jpg">
				</div>
				<div class="carousel-img-two">
				...
				<div class="carousel-img-two">
					<img src="img/linterna.jpg">
				</div>
				<div class="carousel-img-two">
					<img src="img/cuervo.jpg">
				</div>
				<div class="carousel-img-two">
					<img src="img/wendigo.jpg">
				</div>
				<div class="carousel-img-two">
					<img src="img/diosamarillo.jpg">
				</div>
				<div class="carousel-img-two">
		...
		<div class="advert">
			<div class="adcontent">
				<div class="adtitle">
					<img class="lovecraft title" src="img/lovecraft_title.png">
					<a class="signup" href="">READ NOW</a>
				</div>
			</div>
		</div>
	...
	<div class="prices-grid">
		...
		<div class="prices-column">
			...
			<a class="signup" href="">SAVE NOW</a>
			<p>*Saving based on the yearly price paid upfront compared to the monthly price of € 8.99 over 12 months.</p>
		</div>
	</div>

	<div class="advert advert-two">
		<div class="adcontent">
			<div class="adtitle">
				<img class="lovecraft title" src="img/wendigo_title.png">
				<a class="signup" href="">START READING</a>
			</div>
		</div>
	</div>
